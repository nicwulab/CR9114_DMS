...
def main():
  outfile   = 'result/CR9114HC_WT_count_aa.tsv'
  countfile = 'result/CR9114HC_WT_count_nuc.tsv'
  barfile   = 'data/barcodes_WT.tsv'
  roi_len   = 360
  offset    = 0
  refseq    = [line for line in open('Fasta/CR9114_HC_WT.pep','r').readlines()][1].rstrip()
